...
class Controller_Item_Aluguel:
    ...
    def inserir_item_aluguel(self) -> ItemAluguel:
        ...
        self.mongo.close()
        # Retorna o objeto novo_item_aluguel para utilização posterior, caso necessário
        return novo_item_aluguel
    ...
    def atualizar_item_aluguel(self) -> ItemAluguel:
        ...
        if not self.verifica_existencia_item_aluguel(codigo_item_aluguel):
            ...
            self.mongo.close()
            # Retorna o objeto aluguel_atualizado para utilização posterior, caso necessário
            return item_aluguel_atualizado
        else:
            self.mongo.close()
