...
class Relatorio:
        ...
        query_result = mongo.db.alugueis.aggregate([{
                                                   ...
                                                   },
                                                   {
                                                    "$project": {"codigo_aluguel": 1,
                                                                 ...
                                                                 "receita_diaria_possivel": {'$multiply':['$item.quantidade','$item.valor_aluguel_veiculo']},
                                                                 "_id": 0
                                                                }
                                                   }])
    ...
    def get_relatorio_alugueis(self):
        ...
        # Fecha a conexão com o Mongo
        mongo.close()
        print(df_aluguel[["codigo_aluguel", "data_aluguel_inicial", "data_aluguel_final", "cliente", "empresa", "item_aluguel", "veiculo", "quantidade", "valor_aluguel_veiculo", "receita_diaria_possivel"]])
        input("Pressione Enter para Sair do Relatório de Alugueis")
    ...
    def get_relatorio_itens_alugueis(self):
        ...
        query_result = mongo.db['itens_aluguel'].aggregate([{
                                                           ...
                                                           {'$project':{'codigo_aluguel':1, 
                                                                    ...
                                                                    'quantidade':1,
                                                                    'valor_aluguel_veiculo':1,
                                                                    'receita_diaria_possivel':{'$multiply':['$quantidade','$valor_aluguel_veiculo']},
                                                                    '_id':0
                                                                    }}
                                                          ])
        ...
        mongo.close()
        # Exibe o resultado
        print(df_itens_aluguel[["codigo_aluguel", "codigo_item_aluguel", "codigo_veiculo", "modelo_veiculo", "cor_veiculo", "tipo_combustivel", "quantidade", "valor_aluguel_veiculo", "receita_diaria_possivel"]])
